...
public class BlockBox1_9_R2 implements BlockBox {
    ...
    public boolean isUsingItem(Player player) {
        net.minecraft.server.v1_9_R2.EntityLiving entity =
                ((org.bukkit.craftbukkit.v1_9_R2.entity.CraftLivingEntity) player).getHandle();
        return entity.cw() != null
                && entity.cw().getItem()
                .f(entity.cw()) != net.minecraft.server.v1_9_R2.EnumAnimation.NONE;
    }
