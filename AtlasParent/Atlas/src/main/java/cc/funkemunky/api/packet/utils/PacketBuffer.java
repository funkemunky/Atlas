package cc.funkemunky.api.packet.utils;
...
public class PacketBuffer extends ByteBuf
{
    ...
    public BaseBlockPosition readBlockPos()
    {
        return new BaseBlockPosition(this.readLong());
    }

    public void writeBlockPos(BaseBlockPosition pos)
    {
