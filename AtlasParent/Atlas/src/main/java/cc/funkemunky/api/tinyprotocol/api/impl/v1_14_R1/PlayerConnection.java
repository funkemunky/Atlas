package cc.funkemunky.api.tinyprotocol.api.impl.v1_14_R1;

import cc.funkemunky.api.Atlas;
import net.minecraft.server.v1_14_R1.*;

public class PlayerConnection extends net.minecraft.server.v1_14_R1.PlayerConnection {
    ...
    public void a(PacketPlayInSetJigsaw packetplayinsetjigsaw) {
        ...
        Atlas.getInstance().getTinyProtocolHandler().onPacketInAsync(getPlayer().getPlayer(), packetplayinsetjigsaw);
    }

    @Override
    public void a(PacketPlayInDifficultyChange packetplayindifficultychange) {
        super.a(packetplayindifficultychange);
        Atlas.getInstance().getTinyProtocolHandler().onPacketInAsync(getPlayer().getPlayer(), packetplayindifficultychange);
    }

    @Override
    public void a(PacketPlayInDifficultyLock packetplayindifficultylock) {
        super.a(packetplayindifficultylock);
        Atlas.getInstance().getTinyProtocolHandler().onPacketInAsync(getPlayer().getPlayer(), packetplayindifficultylock);
    }
